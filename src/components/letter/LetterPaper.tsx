...
export const LetterPaper = ({ children, visible }: LetterPaperProps) => {
  return (
    ...
    >
      ...
      <div className="relative bg-background/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-border/30 p-8 md:p-12">
        {/* Decorative corners */}
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-2">
          ...
          <div className="w-1.5 h-1.5 rounded-full bg-accent/40 animate-glow" />
          <div className="h-px w-12 bg-gradient-to-r from-transparent via-accent/30 to-transparent" />
        </div>
      </div>
    </div>
